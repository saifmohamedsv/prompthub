  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-3 rounded-lg bg-surface-high px-4 py-3 text-sm font-medium text-foreground transition-colors hover:bg-surface-highest"
      >
