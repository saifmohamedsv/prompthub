...
export function AppSidebar() {
  ...
  return (
    <aside className="hidden md:flex w-64 shrink-0 flex-col border-e border-border bg-sidebar sticky top-14 sm:top-16 h-[calc(100vh-3.5rem)] sm:h-[calc(100vh-4rem)] overflow-y-auto py-6 px-3">
