  ...
  return (
    <article className="group relative flex flex-col rounded-xl border border-card-border bg-surface-1 p-3 shadow-card transition-all hover:border-brand/20 hover:shadow-md">
      ...
      <div className="relative z-10 mt-2 flex items-center justify-between">
        <button type="button" onClick={() => router.push(routes.userProfile(prompt.user_id))} className="group/author flex items-center gap-1.5 transition-colors">
          ...
          <span className="text-[11px] text-foreground-tertiary transition-colors group-hover/author:text-foreground">@{prompt.profiles?.username ?? prompt.profiles?.full_name}</span>
        </button>
